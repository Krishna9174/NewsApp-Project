...
export default class App extends Component {
 pageSize=5;
 apiKey=process.env.REACT_APP_NEWS_APIl
 state={
  progress:0
 }
 setProgress=(progress)=>{
  ...
  render() {
    ...
    <div>
      ...
      />
      <Routes>
          <Route exact path="/" element = {<News setProgress={this.setProgress}  apiKey={this.apiKey}   key="genera"  pageSize={this.pageSize} country="in" category="general"/>}></Route>
